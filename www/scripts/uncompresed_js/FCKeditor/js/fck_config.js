...
//config.EditorAreaCSS = '/ff/themes/vikka/style/style.css' ;

//##
//## Base URL used to set relative links
//##
config.BaseUrl = document.location.protocol + '//' + document.location.host + '/' ;
//config.BaseUrl = document.location.protocol + '//' + document.location.host + '/ff/' ;
//window.defaultStatus = config.BaseUrl; 
...
config.ToolbarSets["Accessibility"] = [
	['EditSource','-','Cut','Copy','Paste','-','SelectAll','RemoveFormat','-','Link','RemoveLink','-','Image','Rule'] ,
	['Bold','Italic','Underline','-','InsertOrderedList','InsertUnorderedList','-','Undo','Redo']
] ;

config.ToolbarSets["Basic"] = [
	['Bold','Italic','-','InsertOrderedList','InsertUnorderedList','-','Link','RemoveLink']
] ;
...
config.ImageBrowserURL = config.BaseUrl + "index.php?module=fm&type=admin&func=select_image";

// Image browsing window sizes
config.ImageBrowserWindowWidth  = 680;
config.ImageBrowserWindowHeight = 400;
