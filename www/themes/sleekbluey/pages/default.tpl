...
<table border="0" cellpadding="0" cellspacing="0" width="97%" align="center">
  <tr>
    <td height="40" background="/themes/sleekbluey/images/header_end_bg_a.gif">
      <div class="top_menu_items" align="center"><a href="/">Главная</a></div>
      <div class="top_menu_items" align="center"><a href="/">Фильмы</a></div>
      <div class="top_menu_items" align="center"><a href="/">Сериалы</a></div>
      <div class="top_menu_items" align="center"><a href="/">Игры</a></div>
      <div class="top_menu_items" align="center"><a href="/">Музыка</a></div>
    </td>
    ...
    <div id="menu_search_box">
      <form method="get" id="searchform" style="display:inline;" action="index.php">
        <script type='text/javascript' src="/scripts/java_scripts/search.js"></script>{*RUS тут нужно объявить скрипт глобально?!*}
