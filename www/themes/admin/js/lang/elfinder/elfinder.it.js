...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.it = {
		...
		messages   : {
			...
			'errURL'               : 'Configurazione non valida.Il parametro URL non ГЁ settato.',
			...
			'errNoVolumes'         : 'Non ГЁ stato possibile leggere i volumi.',
			...
			'errNotFolder'         : 'L\'oggetto non ГЁ una cartella..',
			'errNotFile'           : 'L\'oggetto non ГЁ un file.',
			'errRead'              : 'Impossibile leggere "$1".',
			'errWrite'             : 'Non ГЁ possibile scrivere in "$1".',
			'errPerm'              : 'Permesso negato.',
			'errLocked'            : '"$1" ГЁ bloccato e non puГІ essere rinominato, spostato o eliminato.',
			'errExists'            : 'Il file "$1" ГЁ giГ  esistente.',
			'errInvName'           : 'Nome file non valido.',
			'errFolderNotFound'    : 'Cartella non trovata.',
			'errFileNotFound'      : 'File non trovato.',
			'errTrgFolderNotFound' : 'La cartella di destinazione"$1" non ГЁ stata trovata.',
			...
			'errCopyFrom'          : 'Non ГЁ possibile copiare file da "$1".',
			'errCopyTo'            : 'Non ГЁ possibile copiare file in "$1".',
			...
			'errNoArchive'         : 'Il file non ГЁ un archivio o contiene file non supportati.',
			'errCmdNoSupport'      : 'Il Backend non supporta questo comando.',
			'errReplByChild'       : 'La cartella $1 non puГІ essere sostituita da un oggetto in essa contenuto.',
			'errArcSymlinks'       : 'Per questioni di sicurezza non ГЁ possibile estrarre archivi che contengono collegamenti..',
			...
			'confirmRm'       : 'Sei sicuro di voler rimuovere i file?<br />L\'operazione non ГЁ reversibile!',
			...
			'crop'            : 'Ritaglia',
			'rotate'          : 'Ruota',
			'rotate-cw'       : 'Ruota di 90В° in senso orario',
			'rotate-ccw'      : 'Ruota di 90В° in senso antiorario',
			'degree'          : 'Gradi',
