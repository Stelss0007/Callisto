...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.no = {
		...
		messages   : {
			...
			'errJqui'              : 'Ugyldig jQuery UI konfigurasjon. Selectable, draggable og droppable komponentene mГҐ vГ¦re inkludert.',
			'errNode'              : 'elFinder pГҐkrever at DOM Elementer kan opprettes.',
			...
			'errCmdReq'            : 'Backend spГёrringen pГҐkrever kommando.',
			'errOpen'              : 'Kunne ikke ГҐpne "$1".',
			...
			'errLocked'            : '"$1" er lГҐst og kan ikke flyttes, slettes eller endres',
			...
			'errTrgFolderNotFound' : 'MГҐlmappen "$1" ble ikke funnet.',
			'errPopup'             : 'Nettleseren din blokkerte et pop-up vindu. For ГҐ ГҐpne filen mГҐ du aktivere pop-up i din nettlesers innstillinger.',
			...
			'errMaxSize'           : 'Innholdet overgГҐr maksimum tillatt stГёrrelse.',
			'errFileMaxSize'       : 'Filen vergГҐr maksimum tillatt stГёrrelse.',
			'errUploadMime'        : 'Filtypen ikke tillatt.',
			'errUploadTransfer'    : '"$1" overfГёrings feil.', 
			...
			'errArcType'           : 'akriv-typen er ikke stГёttet.',
			'errNoArchive'         : 'Filen er ikke et arkiv eller et arkiv som ikke er stГёttet.',
			'errCmdNoSupport'      : 'Backend stГёtter ikke denne kommandoen.',
			...
			'cmdopen'      : 'Г…pne',
			'cmdpaste'     : 'Lim inn',
			'cmdquicklook' : 'ForhГҐndsvis',
			'cmdreload'    : 'Last inn pГҐ nytt',
			...
			/********************************** messages **********************************/
			'confirmReq'      : 'Bekreftelse nГёdvendig',
			'confirmRm'       : 'Er du sikker pГҐ at du Гёnsker ГҐ slette filene?',
			...
			'shortcutsof'     : 'Snarveier avslГҐtt',
