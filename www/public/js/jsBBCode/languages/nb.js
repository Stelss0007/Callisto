...
(function ($) {
	...
	$.sceditor.locale["nb-NO"] = {
		...
		"Center": "Midstill",
		"Align right": "Sidestill til hГёyre",
		"Justify": "Normalt oppstilt",
		"Font Name": "Skriftype",
		"Font Size": "SkriftstГёrrelse",
		"Font Color": "skriftfarge",
		"Remove Formatting": "Fjern formatering",
		"Cut": "Klipp",
		"Your browser does not allow the cut command. Please use the keyboard shortcut Ctrl/Cmd-X": "Nettleseren din kan ikke utfГёre klippe kommandoen. Vennligst bruk hurtigtasten Ctrl / Cmd-X",
		"Copy": "Kopier",
		"Your browser does not allow the copy command. Please use the keyboard shortcut Ctrl/Cmd-C": "Nettleseren din kan ikke utfГёre kopier kommandoen. Vennligst bruk hurtigtasten Ctrl / Cmd-C",
		"Paste": "Lim",
		"Your browser does not allow the paste command. Please use the keyboard shortcut Ctrl/Cmd-V": "Nettleseren din kan ikke utfГёre lime kommandoen. Vennligst bruk hurtigtasten Ctrl / Cmd-V",
		"Paste your text inside the following box:": "Lim inn teksten i den fГёlgende boksen:",
		...
		"Height (optional):": "HГёyde (valgfritt):",
