...
(function($) {
    ...
    $pc.fn.extend({
      ...
      this.imgPlay 	= $("<a><div style='width:25px;'></div></a>").appendTo(this.textNav);  
      if(this.options.autoPlay){ this.imgPlay.addClass('pause'); }else{ this.imgPlay.addClass('play'); }
			//this.textControl= $("<a class='play'>"+this.options.text.play+"</a>").appendTo(this.textNav);
      //if(this.options.autoPlay){ this.textControl.addClass('pause'); }else{ this.textControl.addClass('play'); }
        ...
        bindEvents: function() {
          ...
          //this.textControl.bind('click',{self:this},this.playClick);
      ...
      //self.textControl.toggleClass('play').toggleClass('pause');
