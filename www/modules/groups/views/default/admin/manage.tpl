            ...
            <br><br>
             <div class="form-group">
              ...
              <div class="controls col-sm-5">
                <input type="text" name='name' class="form-control" value='{$group->name}' style="width: 98%;">
              </div>
             </div>
             ...
             <div class="form-group">
              ...
              <div class="controls col-sm-5">
                <textarea name='description' class="form-control" style="width: 98%;">{$group->description}</textarea>
              </div>
             </div>
