...
<form method="POST" action="/index.php?module=work&type=user&func=task_create">

              <input name="ask_editcode" value="0" type="hidden">
              <table class="profile" style="margin-bottom: 0;">
                  ...
                  <tbody>
                      <tr>
                          ...
                          <td class="value"><input class="val" name="displayname" maxlength="55" value="" type="text"></td>
                      ...
                      <tr>
                          <td class="value" colspan="2">
                              <textarea style="height: 100px;" cols="40" rows="3" name="description">
                              </textarea>
                          </td>
                      ...
                      <tr>
                          <td class="value" colspan="2">
                              <textarea style="height: 100px;" cols="40" rows="3" name="addinfo" ></textarea>
                          </td>
                      ...
                      <tr>
                          ...
                          <td class="value"><input class="val" name="currency" maxlength="6" value="10" type="text"></td>
