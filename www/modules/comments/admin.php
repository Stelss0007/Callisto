...
class AdminController extends Controller
  ...
  function actionCommentList()
    ...
    $this->articles_list = $this->articles->articleList(true, $this->getInput('filter', array()));
    ...
    $browsein[] =array('url'=>'/admin/articles', 'displayname'=>'Comments'); 
  ...
  function actionAjaxCommentList()
    {
    $this->getAccess(ACCESS_READ);
