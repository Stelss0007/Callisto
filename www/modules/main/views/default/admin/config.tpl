...
<div class="accordion" id="accordion">
    ...
    <div id="group-global" class="panel-collapse collapse in">
      <div class="panel-body">
        ...
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#site_name#}</label>
          <div class="controls col-sm-5">
            <input type="text" name="modconfig[main][site_name]" value="{$modconfig.main.site_name}" class="form-control" >
          </div>
        </div>
          
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#site_slogan#}</label>
          <div class="controls col-sm-5">
            <input type="text" name="modconfig[main][site_slogan]" value="{$modconfig.main.site_slogan}" class="form-control"  >
          </div>
        </div>
          
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#site_description#}</label>
          <div class="controls col-sm-5">
            <textarea  name="modconfig[main][site_description]" class="form-control" >{$modconfig.main.site_description}</textarea>
          </div>
        </div>
          
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#site_footer#}</label>
          <div class="controls col-sm-5">
        ...
        <div class="form-group">
          ...
          <div class="controls col-sm-5">
             <select data-rel="chosen_" name="modconfig[main][site_dateformat]" class="form-control selectpicker" >
        ...
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#site_timeformat#}</label>
          <div class="controls col-sm-5">
            <select data-rel="chosen_" name="modconfig[main][site_timeformat]" class="form-control selectpicker" >
        ...
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#site_offline#}</label>
          <div class="controls col-sm-5">
        ...
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#site_offline_message#}</label>
          <div class="controls col-sm-5">
            <textarea  name="modconfig[main][site_offline_message]" class="form-control" >{$modconfig.main.site_offline_message|default:'Сайт закрыт на техническое обслуживание.<br /> Пожалуйста, зайдите позже.'}</textarea>
          </div>
        </div>
              
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#site_list_lenght#}</label>
          <div class="controls col-sm-5">
            <select data-rel="chosen_" name="modconfig[main][site_list_lenght]" class="form-control selectpicker" >
    ...
    <div id="group-seo" class="panel-collapse collapse">
      <div class="panel-body">
        <div class="panel-body">
          ...
          <div class="form-group">
            <label for="date01" class="col-sm-3 control-label">{#site_seo_description#}</label>
            <div class="controls col-sm-5">
              <textarea  name="modconfig[main][site_seo_description]" class="form-control" >{$modconfig.main.site_seo_description}</textarea>
            </div>
          </div>
            
          <div class="form-group">
            <label for="date01" class="col-sm-3 control-label">{#site_seo_keywords#}</label>
            <div class="controls col-sm-5">
              <textarea  name="modconfig[main][site_seo_keywords]" class="form-control" >{$modconfig.main.site_seo_keywords}</textarea>
            </div>
          </div>
            
          <div class="form-group">
            <label for="date01" class="col-sm-3 control-label">{#site_seo_robots#}</label>
            <div class="controls col-sm-5">
             <select data-rel="chosen_" name="modconfig[main][site_seo_robots]" class="form-control selectpicker" >
  ...
  <div class="panel panel-default">
    ...
    <div id="group-mail" class="panel-collapse collapse">
      <div class="panel-body">
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#mail_type#}</label>
          <div class="controls col-sm-5">
            <select data-rel="chosen_" name="modconfig[main][site_email_type]" class="form-control selectpicker" >
        ...
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#mail_site_from#}</label>
          <div class="controls col-sm-5">
            <input type="text" name="modconfig[main][site_email_from]" value="{$modconfig.main.site_email_from}" class="form-control" >
          </div>
        </div>
          
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#mail_site_sender#}</label>
          <div class="controls col-sm-5">
            <input type="text" name="modconfig[main][site_email_sender]" value="{$modconfig.main.site_email_sender}" class="form-control" >
          </div>
        </div>
          
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#mail_smtp_server#}</label>
          <div class="controls col-sm-5">
            <input type="text" name="modconfig[main][site_email_smtp_server]" value="{$modconfig.main.site_email_smtp_server}" class="form-control" >
          </div>
        </div>
        ...
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#mail_type#}</label>
          <div class="controls col-sm-5">
            <select data-rel="chosen_" name="modconfig[main][site_smtp_sec]" class="form-control selectpicker" >
        ...
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#mail_smtp_port#}</label>
          <div class="controls col-sm-5">
            <input type="text" name="modconfig[main][site_email_smtp_port]" value="{$modconfig.main.site_email_smtp_port}" class="form-control" >
          </div>
        </div>
          
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#mail_smtp_user#}</label>
          <div class="controls col-sm-5">
            <input type="text" name="modconfig[main][site_email_smtp_user]" value="{$modconfig.main.site_email_smtp_user}" class="form-control" >
          </div>
        </div>
          
        <div class="form-group">
          <label for="date01" class="col-sm-3 control-label">{#mail_smtp_password#}</label>
          <div class="controls col-sm-5">
            <input type="text" name="modconfig[main][site_email_smtp_password]" value="{$modconfig.main.site_email_smtp_password}" class="form-control" >
          </div>
        </div>
