  ...
  <div class="box span12">
    ...
    <form action="/admin/module/group_operation">
      <div class="btn-toolbar batch-actions-buttons">
        <div class="btn-group">
          <a href='/admin/module/create{if $parent_id}/{$parent_id}{/if}' class='btn btn-success'><i class="icon icon-plus-sign icon-white"></i> {#sys_add#}</a>
        ...
        <tbody>
          {foreach from=$modules_list_all item=module name=module_}
            ...
            <tr class='{$class}'>
              ...
              <td>
                <div class="btn-group">
                  <a href='/admin/module/modify/{$module.id}' title="{#sys_edit#}" class="btn btn-icon btn-edit"><i class="icon-edit"></i></a>
                  <a href='/admin/module/delete/{$module.id}' title="{#sys_delete#}" class="btn btn-icon btn-delete" onclick="return confirm('{#sys_confirm_delete#}');"><i class="icon-trash"></i></a>
                </div>
              </td>
            </tr>
          {/foreach}
